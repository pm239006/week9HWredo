...
import { InputText } from '../sharedComponent/Inputs';
...
const columns: GridColDef[] = [
  { field: 'image', //needs to match keys on our Order Object/Dictionary 
    ...
    width: 150,
    renderCell: (params: { row: { image: string | undefined; name: string | undefined; }; }) => (
        <img
...
export const Order = () => {
    ...
    return (
        ...
        <DataGrid
            ...
            onRowSelectionModelChange = {(newSelectionModel: any) => setGridData(newSelectionModel)}
        />
